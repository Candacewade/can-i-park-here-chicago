    ...
    <header className="hero">
      <div className="hero-copy">
        ...
        <div className="hero-chips">
          ...
          <span className="hero-chip">
            <span className="chip-ic ic-violet">
...
function Skyline() {
  return (
    <svg className="skyline" viewBox="0 0 420 200" aria-hidden="true">
      ...
      <rect width="420" height="200" fill="url(#sky)" rx="16" />
      <g fill="url(#bld)">
      ...
      <rect x="0" y="182" width="420" height="18" fill="#c7d2fe" opacity="0.6" />
      {/* parking sign */}
      <rect x="332" y="140" width="3" height="44" fill="#94a3b8" />
      <rect x="320" y="132" width="27" height="24" rx="5" fill="#22c55e" />
      <text x="333.5" y="150" fontSize="16" fontWeight="700" fill="#fff" textAnchor="middle">
        P
      </text>
      {/* car */}
      <g fill="#64748b">
      ...
      <circle cx="269" cy="190" r="4" fill="#334155" />
      <circle cx="295" cy="190" r="4" fill="#334155" />
    </svg>
  );
}
